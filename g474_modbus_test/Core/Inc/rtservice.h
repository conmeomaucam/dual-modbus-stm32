 ...
 * would return 16.
 * [TIẾNG VIỆT] Căn biên lên (Memory Alignment Up). Làm tròn kích thước lên bội số của `align`.
 */
 ...
 * would return 12.
 * [TIẾNG VIỆT] Căn biên xuống (Memory Alignment Down). Làm tròn kích thước xuống bội số của `align`.
 */
#define RT_ALIGN_DOWN(size, align) ((size) & ~((align)-1))

/**
 * Double List structure
 * [TIẾNG VIỆT] Cấu trúc Danh sách liên kết đôi (Double-linked List) kế thừa từ RT-Thread.
 */
struct rt_list_node {
